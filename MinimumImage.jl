...
#	coordinates = zeros(2N)
#	num = 1
#	for i in 1:n
#		for j in 1:n
#			coordinates[num] = a * (i - 0.5)
#			coordinates[num+N] = a * (j - 0.5)
#			num += 1
#		end
#	end
...
function demo_1(p1::Int64, p2::Int64; N::Int64=25, L::Float64=10.0)
	...
	plot!([ r1[1], r1[1] + r12[1]], [ r1[2], r1[2] + r12[2] ])
end
